  ...
  return (
    <Layout>
      ...
      <section className="relative py-12 bg-[hsl(205,30%,95%)] overflow-hidden">
        {/* Background fills — glass style */}
        <div className="absolute top-6 right-[8%] w-72 h-72 rounded-full bg-[hsl(205,78%,6%)]/[0.25] backdrop-blur-xl border border-white/[0.06]" />
        <div className="absolute bottom-10 left-[5%] w-52 h-52 rounded-full bg-[hsl(205,78%,6%)]/[0.20] backdrop-blur-xl border border-white/[0.05]" />
        <div className="absolute top-[10%] left-[30%] w-36 h-36 rounded-full bg-[hsl(205,78%,6%)]/[0.15] backdrop-blur-lg border border-white/[0.06]" />
        <div className="absolute bottom-[25%] right-[18%] w-28 h-28 rounded-full bg-[hsl(205,78%,6%)]/[0.12] backdrop-blur-lg border border-white/[0.05]" />
        <div className="absolute top-1/2 left-0 w-28 h-px bg-gradient-to-r from-[hsl(205,78%,6%)]/[0.30] to-transparent" />
        <div className="absolute top-[20%] left-[15%] w-px h-28 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.25] to-transparent" />
        <div className="absolute bottom-[30%] right-[20%] w-px h-24 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.20] to-transparent" />
        <div className="absolute top-[15%] right-[30%] w-3 h-3 rounded-full bg-[hsl(205,78%,6%)]/[0.40] backdrop-blur-sm border border-white/[0.08]" />
        <div className="absolute bottom-[40%] left-[12%] w-2.5 h-2.5 rounded-full bg-[hsl(205,78%,6%)]/[0.35] backdrop-blur-sm border border-white/[0.07]" />
      ...
      <section className="relative overflow-hidden bg-[hsl(205,30%,95%)]">
        {/* Background fills — glass style */}
        <div className="absolute top-0 left-[12%] w-80 h-80 rounded-full bg-[hsl(205,78%,6%)]/[0.25] backdrop-blur-xl border border-white/[0.06]" />
        <div className="absolute bottom-0 right-[8%] w-96 h-96 rounded-full bg-[hsl(205,78%,6%)]/[0.18] backdrop-blur-xl border border-white/[0.05]" />
        <div className="absolute top-[8%] right-[25%] w-44 h-44 rounded-full bg-[hsl(205,78%,6%)]/[0.15] backdrop-blur-lg border border-white/[0.06]" />
        <div className="absolute bottom-[15%] left-[5%] w-32 h-32 rounded-full bg-[hsl(205,78%,6%)]/[0.12] backdrop-blur-lg border border-white/[0.05]" />
        ...
        <div className="absolute top-8 left-8 w-32 h-32 rounded-full bg-[hsl(205,78%,6%)]/[0.15] backdrop-blur-lg border border-white/[0.06]" />
        <div className="absolute top-12 left-12 w-24 h-24 rounded-full bg-[hsl(205,78%,6%)]/[0.10] backdrop-blur-md border border-white/[0.05]" />
        <div className="absolute bottom-16 right-12 w-40 h-40 bg-[hsl(205,78%,6%)]/[0.12] backdrop-blur-lg border border-white/[0.05] rotate-45" />
        <div className="absolute top-1/2 right-6 w-px h-36 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.30] to-transparent" />
        <div className="absolute top-[40%] left-4 w-24 h-px bg-gradient-to-r from-[hsl(205,78%,6%)]/[0.25] to-transparent" />
        <div className="absolute top-[20%] left-[40%] w-px h-28 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.20] to-transparent" />
        <div className="absolute top-[5%] right-[15%] w-3 h-3 rounded-full bg-[hsl(205,78%,6%)]/[0.40] backdrop-blur-sm border border-white/[0.08]" />
        <div className="absolute bottom-[10%] left-[20%] w-2.5 h-2.5 rounded-full bg-[hsl(205,78%,6%)]/[0.35] backdrop-blur-sm border border-white/[0.07]" />
        <div className="absolute top-[70%] right-[35%] w-2 h-2 rounded-full bg-[hsl(205,78%,6%)]/[0.30] backdrop-blur-sm border border-white/[0.06]" />
      ...
      <section className="relative py-14 bg-[hsl(205,30%,95%)] overflow-hidden">
        {/* Background fills — glass style */}
        <div className="absolute top-12 right-[6%] w-80 h-80 rounded-full bg-[hsl(205,78%,6%)]/[0.25] backdrop-blur-xl border border-white/[0.06]" />
        <div className="absolute bottom-16 left-[10%] w-64 h-64 rounded-full bg-[hsl(205,78%,6%)]/[0.20] backdrop-blur-xl border border-white/[0.05]" />
        <div className="absolute top-[8%] left-[30%] w-40 h-40 rounded-full bg-[hsl(205,78%,6%)]/[0.15] backdrop-blur-lg border border-white/[0.06]" />
        <div className="absolute top-[55%] right-[12%] w-32 h-32 rounded-full bg-[hsl(205,78%,6%)]/[0.12] backdrop-blur-lg border border-white/[0.05]" />
        <div className="absolute top-1/3 left-0 w-32 h-px bg-gradient-to-r from-[hsl(205,78%,6%)]/[0.30] to-transparent" />
        <div className="absolute bottom-1/3 right-0 w-36 h-px bg-gradient-to-l from-[hsl(205,78%,6%)]/[0.30] to-transparent" />
        <div className="absolute top-[12%] left-[22%] w-px h-32 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.25] to-transparent" />
        <div className="absolute bottom-[20%] right-[25%] w-px h-28 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.20] to-transparent" />
        <div className="absolute top-[45%] left-[5%] w-20 h-20 rounded-full bg-[hsl(205,78%,6%)]/[0.12] backdrop-blur-md border border-white/[0.05]" />
        <div className="absolute top-[75%] left-[40%] w-24 h-24 rounded-full bg-[hsl(205,78%,6%)]/[0.10] backdrop-blur-md border border-white/[0.05]" />
        <div className="absolute top-[5%] right-[35%] w-3 h-3 rounded-full bg-[hsl(205,78%,6%)]/[0.40] backdrop-blur-sm border border-white/[0.08]" />
        <div className="absolute top-[25%] left-[8%] w-2.5 h-2.5 rounded-full bg-[hsl(205,78%,6%)]/[0.35] backdrop-blur-sm border border-white/[0.07]" />
        <div className="absolute bottom-[15%] right-[8%] w-2 h-2 rounded-full bg-[hsl(205,78%,6%)]/[0.30] backdrop-blur-sm border border-white/[0.06]" />
      ...
      <section className="relative bg-[hsl(205,30%,95%)] overflow-hidden">
        {/* Background fills — glass style */}
        <div className="absolute top-10 left-[18%] w-56 h-56 rounded-full bg-[hsl(205,78%,6%)]/[0.25] backdrop-blur-xl border border-white/[0.06]" />
        <div className="absolute bottom-10 right-[12%] w-72 h-72 rounded-full bg-[hsl(205,78%,6%)]/[0.20] backdrop-blur-xl border border-white/[0.05]" />
        <div className="absolute top-[15%] right-[30%] w-36 h-36 rounded-full bg-[hsl(205,78%,6%)]/[0.15] backdrop-blur-lg border border-white/[0.06]" />
        <div className="absolute bottom-[20%] left-[8%] w-28 h-28 rounded-full bg-[hsl(205,78%,6%)]/[0.12] backdrop-blur-lg border border-white/[0.05]" />
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[hsl(205,78%,6%)]/[0.25] to-transparent" />
        <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[hsl(205,78%,6%)]/[0.25] to-transparent" />
        <div className="absolute top-[30%] right-[5%] w-px h-28 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.25] to-transparent" />
        <div className="absolute bottom-[35%] left-[3%] w-px h-24 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.20] to-transparent" />
        <div className="absolute top-[5%] left-[40%] w-3 h-3 rounded-full bg-[hsl(205,78%,6%)]/[0.40] backdrop-blur-sm border border-white/[0.08]" />
        <div className="absolute bottom-[15%] right-[25%] w-2.5 h-2.5 rounded-full bg-[hsl(205,78%,6%)]/[0.35] backdrop-blur-sm border border-white/[0.07]" />
      ...
      <section className="relative overflow-hidden bg-[hsl(205,30%,95%)]">
        {/* Background fills — glass style */}
        <div className="absolute top-8 left-[8%] w-64 h-64 rounded-full bg-[hsl(205,78%,6%)]/[0.25] backdrop-blur-xl border border-white/[0.06]" />
        <div className="absolute bottom-8 right-[6%] w-80 h-80 rounded-full bg-[hsl(205,78%,6%)]/[0.20] backdrop-blur-xl border border-white/[0.05]" />
        <div className="absolute top-[10%] right-[20%] w-40 h-40 rounded-full bg-[hsl(205,78%,6%)]/[0.15] backdrop-blur-lg border border-white/[0.06]" />
        <div className="absolute bottom-[18%] left-[15%] w-32 h-32 rounded-full bg-[hsl(205,78%,6%)]/[0.12] backdrop-blur-lg border border-white/[0.05]" />
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[hsl(205,78%,6%)]/[0.25] to-transparent" />
        <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[hsl(205,78%,6%)]/[0.25] to-transparent" />
        <div className="absolute top-6 right-16 w-24 h-24 rounded-full bg-[hsl(205,78%,6%)]/[0.15] backdrop-blur-lg border border-white/[0.06]" />
        <div className="absolute bottom-10 left-12 w-20 h-20 bg-[hsl(205,78%,6%)]/[0.12] backdrop-blur-lg border border-white/[0.05] rotate-45" />
        <div className="absolute top-1/2 left-0 w-24 h-px bg-gradient-to-r from-[hsl(205,78%,6%)]/[0.30] to-transparent" />
        <div className="absolute top-[25%] right-[25%] w-px h-28 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.25] to-transparent" />
        <div className="absolute bottom-[30%] left-[35%] w-px h-24 bg-gradient-to-b from-transparent via-[hsl(205,78%,6%)]/[0.20] to-transparent" />
        <div className="absolute top-[8%] left-[45%] w-3 h-3 rounded-full bg-[hsl(205,78%,6%)]/[0.40] backdrop-blur-sm border border-white/[0.08]" />
        <div className="absolute bottom-[12%] right-[40%] w-2.5 h-2.5 rounded-full bg-[hsl(205,78%,6%)]/[0.35] backdrop-blur-sm border border-white/[0.07]" />
