...
const galleryImages = [{
  src: heroImg1,
  alt: "Baffles acústicos coloridos suspensos"
}, {
  src: heroImg12,
  alt: "Painéis coloridos em sala de reunião"
}, {
  src: heroImg3,
  alt: "Nuvem acústica colorida"
}, {
  src: heroImg10,
  alt: "Painéis coloridos no teto e paredes"
}, {
  src: heroImg13,
  alt: "Estúdio com painéis acústicos"
}, {
  src: heroImg6,
  alt: "Forro acústico corporativo"
}, {
  src: heroImg14,
  alt: "Escritório com painéis azuis"
}, {
  src: heroImg8,
  alt: "Painéis suspensos decorativos"
}, {
  src: heroImg11,
  alt: "Painéis em escritório rústico"
}, {
  src: heroImg16,
  alt: "Painéis em seminário"
}, {
  src: heroImg9,
  alt: "Painéis acústicos azuis residencial"
}, {
  src: heroImg15,
  alt: "Painel com imagem digital plotada"
}];
const HomePage = () => {
  return <Layout>
      {/* Hero with image mosaic */}
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-background via-background to-secondary/20 border-destructive-foreground text-muted bg-destructive-foreground" />
      ...
      <section className="section-padding bg-secondary/20">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            ...
            delay: i * 0.05
          }} className={`glass-card overflow-hidden rounded-xl group cursor-pointer ${i === 0 || i === 5 ? "md:col-span-2 md:row-span-2" : ""}`}>
                <img src={img.src} alt={img.alt} className={`w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 ${i === 0 || i === 5 ? "aspect-square" : "aspect-[4/3]"}`} loading="lazy" />
              </motion.div>)}
          </div>
        </div>
      </section>
