        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              ...
              <Link
                to="/orcamento"
                className="px-6 py-3 border border-border text-foreground font-semibold rounded-md hover:bg-secondary transition-colors"
              >
                Solicitar Orçamento
              </Link>
            </div>
        ...
        <div className="container mx-auto">
          <div className="glass-card p-12 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Link
                to="/orcamento"
                className="mt-6 inline-flex items-center gap-2 px-8 py-3 bg-primary text-primary-foreground font-semibold rounded-md hover:bg-primary/90 transition-colors"
              >
