    ...
    <Layout>
                ...
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 items-center`}>
                  ...
                  <div className={`p-4 md:p-6 ${i % 2 === 1 ? "lg:order-1" : ""}`}>
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 rounded-xl bg-white/[0.08] backdrop-blur-md border border-white/[0.1] flex items-center justify-center">
                    ...
                    <p className="mt-4 leading-relaxed text-white/65 text-lg">{step.desc}</p>
      ...
      <section className="py-14 px-6 bg-[hsl(205,78%,8%)] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <motion.div {...fadeUp} className="rounded-3xl border border-white/[0.1] bg-white/[0.05] backdrop-blur-2xl backdrop-saturate-150 p-10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_8px_32px_-8px_rgba(0,0,0,0.2)]">
              ...
              <ul className="mt-8 space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-sm text-white/80 rounded-lg px-3 py-2 bg-white/[0.04] border border-white/[0.06] backdrop-blur-md">
            ...
            <motion.div {...fadeUp} className="grid grid-cols-2 gap-4">
              <div className="rounded-2xl bg-white/[0.05] backdrop-blur-2xl backdrop-saturate-150 border border-white/[0.08] p-2 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)]">
                <div className="rounded-xl overflow-hidden aspect-[3/4]">
                  <img src={heroBafflesColor} alt="" className="w-full h-full object-cover" loading="lazy" />
                </div>
              </div>
              <div className="rounded-2xl bg-white/[0.05] backdrop-blur-2xl backdrop-saturate-150 border border-white/[0.08] p-2 mt-12 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)]">
                <div className="rounded-xl overflow-hidden aspect-[3/4]">
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center">
          <motion.div {...fadeUp} className="rounded-3xl border border-white/[0.1] bg-white/[0.05] backdrop-blur-2xl backdrop-saturate-150 px-8 py-14 mx-auto max-w-3xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_8px_32px_-8px_rgba(0,0,0,0.2)]">
